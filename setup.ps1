...
choco install visualstudio2022buildtools --version=117.14.37 --package-parameters "--add Microsoft.VisualStudio.Workload.VCTools --includeRecommended --quiet --wait" --yes --limit-output
